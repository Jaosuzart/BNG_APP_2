<div class="container-fluid py-5"> <div class="row justify-content-center">
        ...
        <div class="d-flex flex-row flex-wrap justify-content-center py-3 mb-4">
            ...
            <?php if ($user->profile == 'agent') : ?>
                <a href="?ct=agent&mt=my_clients" class="unlink m-3">
            ...
            <?php if ($user->profile == 'agent') : ?>
                <a href="?ct=agent&mt=new_client_frm" class="unlink m-3">
                    <div class="home-option p-5 text-center">
            ...
            <?php if ($user->profile == 'agent') : ?>
                <a href="?ct=agent&mt=upload_file_frm" class="unlink m-3">
                    <div class="home-option p-5 text-center">
            ...
            <?php if ($user->profile == 'admin') : ?>
                <a href="?ct=admin&mt=all_clients" class="unlink m-3">
                    <div class="home-option p-5 text-center">
                        <h3 class="mb-3"><i class="fa-solid fa-users"></i></h3>
                        <h5>Clientes</h5>
                    </div>
            ...
            <?php if ($user->profile == 'admin') : ?>
                <a href="?ct=admin&mt=stats" class="unlink m-3">
                    <div class="home-option p-5 text-center">
            ...
            <?php if ($user->profile == 'admin') : ?>
                <a href="?ct=admin&mt=agents_management" class="unlink m-3">
                    <div class="home-option p-5 text-center">

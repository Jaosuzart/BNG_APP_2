...
<div class="container-fluid py-5 mb-5 mt-4">
    ...
    <div class="row justify-content-center mb-4">
        ...
        <div class="col-12 col-xl-6 mb-4">
            <div class="card shadow border-0 h-100">
                <div class="card-header bg-white border-0 mt-3 ms-3">
                    <h7 class="mb-0"><i class="fa-solid fa-chart-pie me-2"></i>Gráfico Visual</h7>
                </div>
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-6 col-lg-3 mb-3">
            <div class="card shadow border-0 text-center p-3 text-success h-100">
                <h7><i class="fa-solid fa-users"></i></h7>
        ...
        <div class="col-md-6 col-lg-3 mb-3">
            <div class="card shadow border-0 text-center p-3 text-danger h-100">
                <h7><i class="fa-solid fa-user-xmark"></i></h7>
                <h7 class="text-dark">Eliminados</h7>
                <h7 class="fw-bold"><?= $global_stats['total_deleted_clients']->value ?></h7>
            </div>
        </div>
        <div class="col-md-6 col-lg-3 mb-3">
            <div class="card shadow border-0 text-center p-3 text-info h-100">
                <h7><i class="fa-solid fa-calculator"></i></h7>
                <h7 class="text-dark">Média p/ Agente</h7>
                <h7 class="fw-bold"><?= $global_stats['average_clients_per_agent']->value ?></h7>
            </div>
        </div>
    </div>
    ...
    <div class="row mb-5 pb-5">
        <div class="col-12 text-center">
            <div class="card shadow-sm border-0 p-4">
                <h7 class="mb-3 text-muted">Exportar Relatório</h7>
                <div>

...
if (file_exists($envPath)) {
    ...
    foreach ($lines as $line) {
        ...
        // Processa linhas com chave=valor
    ...
    // Se não achar o arquivo, para tudo para evitar vazamento de dados ou erros de conexão
...
// Usa o mesmo email para login SMTP e como remetente (FROM)
define('EMAIL_USER', $env['EMAIL_USERNAME'] ?? '');
define('EMAIL_PASS', $env['EMAIL_PASSWORD'] ?? '');
define('EMAIL_FROM', $env['EMAIL_USERNAME'] ?? '');